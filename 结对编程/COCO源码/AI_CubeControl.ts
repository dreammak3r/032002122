import { _decorator, Component, Node, Prefab, instantiate, CCInteger, CCBoolean, find, Event, NodeEventTyp,AudioSource} from 'cc';
...
@ccclass('AICubeControl')
export class AICubeControl extends Component {
    //引入预制体变量
    @property(Prefab)
    ...
    initial() {
        ...
        this.myParentScript = this.myParent.getComponent(AIChessBoradControl);
